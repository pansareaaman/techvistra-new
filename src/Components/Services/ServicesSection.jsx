...
const ServicesSection = () => {
  return (
    <section className=" text-white py-12 px-6 md:px-10 flex flex-col gap-4 md:flex-row items-center justify-between bg-[#231A29] rounded-xl max-w-[85%] mx-auto">
      {/* Left Side - Image */}
      <div className="md:w-1/2 flex justify-center">
        <img
          src="/Image/Pc.png" // Replace with actual path
          alt="Developer Working"
           className="w-auto h-96 md-mx:h-72 xs-mx:h-60 drop-shadow-lg"
      ...
      <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
        <h2 className="bg-gradient-to-r from-[#765b92] to-[#c2a2e3] bg-clip-text text-transparent text-3xl bs-mx:text-2xl md:text-4xl font-bold">
          We develop high-quality web and mobile applications for organizations, institutions, and SMEs
        </h2>
        <p className="text-gray-300 text-lg mt-4 bs-mx:text-base">
          Our team is well-versed in software development and is ready to help develop the applications of your choice.
        </p>
        <p className="text-gray-300 text-lg mt-2 bs-mx:text-base">
